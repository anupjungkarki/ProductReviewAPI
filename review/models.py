...
class Product(models.Model):
    ...
    # Which Is One Product Has Many Category Associated With The particular product
    category = models.ManyToManyField(Category, related_name='products')
    image = models.ManyToManyField('review.Image', related_name='products')
...
class ProductSite(models.Model):
    ...
    productsize = models.ForeignKey(ProductSize, on_delete=models.CASCADE, related_name='sites',
